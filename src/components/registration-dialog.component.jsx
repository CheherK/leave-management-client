...
import { userCreate } from '../store/user/user.reducer';
...
const RegistrationDialog = ({ open, handleClose }) => {
   ...
   const handleFormSubmit = async (values, { setSubmitting }) => {
      ...
      try {
         dispatch(userCreate(dataForRequest));
   ...
   return (
      <Dialog maxWidth='md' fullWidth open={open} onClose={handleClose}>
         <DialogTitle>
            <Header title="Formulaire" subtitle="Formulaire d&apos;inscription pour ajouter un nouveau employé." />
         </DialogTitle>
         <DialogContent>
            {
               userCreated || error ?
                  ...
                  >
                     {
                        !error ?
                           "L'ajout de l'utilisateur a été réalisé avec succès."
                           :
                           ...
                           {({
                              ...
                              <form onSubmit={handleSubmit}>
                                 ...
                                 <Box mt="30px" display="flex" gap="10px" justifyContent="flex-end">
                                    ...
                                    <Button color="success" variant="outlined" type="submit">Ajouter</Button>
                                 </Box>
                              </form>
                           )}
                        </Formik>
